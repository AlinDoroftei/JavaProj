...
public class Cat {
   private String color;
    ...
    public String getFavouriteFood(){return this.favouriteFood;}

    public void setHealthCondition(short healthCondition){
        this.healthCondition=healthCondition;
    }
    public short getHealthCondition(){return this.healthCondition;}

    public void setHungryFeeling(short hungryFeeling){
        this.hungryFeeling=hungryFeeling;
    }
    public short getHungryFeeling(){return this.hungryFeeling;}

    public void setMoodCondition(short moodCondition){
        this.moodCondition=moodCondition;
    }
    public short getMoodCondition(){return this.moodCondition;}
